...
const Banner = () => {
  return (
    <div className="lg:mx-20 lg:pt-5">
      ...
      <figure className="w-3/4 lg:w-1/2 mx-auto border-2 bg-white/25 border-white rounded-lg p-1 lg:rounded-4xl lg:p-6 absolute bottom-[220px] lg:bottom-[-50px] left-0 right-0">
